...
func (bs *BoltStorage) IsNewBittrexDeposit(id uint64, actID common.ActivityID) bool {
	res := true
...
func (bs *BoltStorage) RegisterBittrexDeposit(id uint64, actID common.ActivityID) error {
	var err error
